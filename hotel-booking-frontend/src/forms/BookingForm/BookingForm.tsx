      ...
      <CardContent className="space-y-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <textarea
                ...
                className="w-full rounded-md border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none"
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-r from-primary-50 to-primary-50 p-4 rounded-lg border border-primary-100">
